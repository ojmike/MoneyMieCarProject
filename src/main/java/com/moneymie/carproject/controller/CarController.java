...
public class CarController {
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<Car> findByParameter(@PathVariable("searchParameter")  String searchParameter){
    ...
    @ResponseStatus(HttpStatus.OK)
    public List<CarResponse> findByParameterAndOrder(@PathVariable("searchParameter")  String searchParameter, @PathVariable("orderBy")  String orderBy){
